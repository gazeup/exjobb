...
from evaluation import evaluate_logistic
...
# Generate binary predictions, needed for logistic regression
predictions_lr_binary = (probabilities > 0.5).astype(int)

# Calculate and print Accuracy, Precision, Recall, F1 score, ROC and Confusion Matrix
evaluate_logistic(y_test, predictions, probabilities, predictions_lr_binary)